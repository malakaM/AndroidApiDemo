 ...
 * focus behavior by calling {@link android.view.FocusFinder} methods directly.
 *
 ...
 *
 * Even as a lighter weight test, this test still needs access to a {@link android.content.Context}
 * to inflate the file, which is why it extends {@link android.test.AndroidTestCase}.
 * 
 * If you ever need a context to do your work in tests, you can extend
 * {@link android.test.AndroidTestCase}, and when run via an {@link android.test.InstrumentationTestRunner},
