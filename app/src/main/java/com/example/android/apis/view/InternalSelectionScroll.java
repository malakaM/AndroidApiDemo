 ...
 * ({@link com.example.android.apis.view.InternalSelectionView}) can cause its parent {@link android.widget.ScrollView}
 * to scroll to keep the internally interesting rectangle on the screen.
 *
 * {@link com.example.android.apis.view.InternalSelectionView} achieves this by calling {@link android.view.View#requestRectangleOnScreen}
