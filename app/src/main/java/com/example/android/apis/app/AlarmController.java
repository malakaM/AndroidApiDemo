 ...
 * {@link com.example.android.apis.app.OneShotAlarm} for the code run when the one-shot alarm goes off, and
 * {@link com.example.android.apis.app.RepeatingAlarm} for the code run when the repeating alarm goes off.
 * <h4>Demo</h4>
