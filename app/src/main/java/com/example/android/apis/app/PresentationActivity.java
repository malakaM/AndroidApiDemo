 ...
 * on a secondary display using a {@link android.app.Presentation}.
 * </p><p>
 * The activity uses the {@link android.hardware.display.DisplayManager} API to enumerate displays.
 * When the user selects a display, the activity opens a {@link android.app.Presentation}
...
public class PresentationActivity extends Activity
    ...
    /**
     * Shows a {@link android.app.Presentation} on the specified display.
     */
    ...
    /**
     * Hides a {@link android.app.Presentation} on the specified display.
     */
     ...
     * We use it to update the list and show a new {@link android.app.Presentation} when a
     * display is connected.
     *
     * Note that we don't bother dismissing the {@link android.app.Presentation} when a
     ...
     * own {@link android.content.Context} whenever we load resources.
     */
