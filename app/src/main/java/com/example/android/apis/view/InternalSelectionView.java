 ...
 * 1) calls {@link android.view.View#requestRectangleOnScreen} each time the selection changes due to
 *    internal navigation.
 * 2) overrides {@link android.view.View#getFocusedRect} by filling in the rectangle of the currently
 *    selected row
 * 3) overrides {@link android.view.View#onFocusChanged} and sets selection appropriately according to
