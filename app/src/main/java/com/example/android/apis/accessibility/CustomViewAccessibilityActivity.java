...
public class CustomViewAccessibilityActivity extends Activity {
     ...
     * For example, {@link android.view.accessibility.AccessibilityNodeInfo} was introduced in
     * {@link android.os.Build.VERSION_CODES#ICE_CREAM_SANDWICH API 14}, thus overriding
     * {@link android.view.View#onInitializeAccessibilityNodeInfo(android.view.accessibility.AccessibilityNodeInfo)
     *  View.onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo)}
     * will prevent you application from running on a platform older than
     * {@link android.os.Build.VERSION_CODES#ICE_CREAM_SANDWICH API 14}.
     * </p>
     */
