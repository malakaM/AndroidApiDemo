...
/**
 * This class is an {@link android.accessibilityservice.AccessibilityService} that provides custom feedback
...
public class ClockBackService extends AccessibilityService {
    ...
    /**
     * Handle to this service to enable inner classes to access the {@link android.content.Context}.
     */
    Context mContext;
    ...
    /** The {@link android.speech.tts.TextToSpeech} used for speaking. */
    private TextToSpeech mTts;

    /** The {@link android.media.AudioManager} for detecting ringer state. */
    ...
    /** {@link android.os.Handler} for executing messages on the service main thread. */
    ...
    /**
     * {@link android.content.BroadcastReceiver} for receiving updates for our context - device
     * state.
     */
     ...
     * configurations:
     * <p>
     *   1. {@link android.media.AudioManager#RINGER_MODE_SILENT}<br/>
     ...
     * </p>
     * <p>
     *   2. {@link android.media.AudioManager#RINGER_MODE_VIBRATE}<br/>
     ...
     * </p>
     * <p>
     *   3. {@link android.media.AudioManager#RINGER_MODE_NORMAL}
    ...
    /**
     * Sets the {@link android.accessibilityservice.AccessibilityServiceInfo} which informs the system how to
     * handle this {@link android.accessibilityservice.AccessibilityService}.
     *
    ...
    /**
     * Formats an utterance from an {@link android.view.accessibility.AccessibilityEvent}.
     *
